...
```jsonc
{
  ...
  "lore": {
    ...
    "origin": "...",                        // optional short fields (lore section of 5): who made it and what for
    "habitat": "...",                       // where it lives now
    "feeding": "...",                       // how it eats
    "behavior": "...",                      // how it goes about its business
    "company": "..."                        // alone, pairs, crews, swarms; omit any field with no source
  },
  "physiology": {
