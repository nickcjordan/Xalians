...
- One action cell per name: STRUCK by Nick 2026-09-07. A name may sit in more than one cell (and in the neutral pool as well as an element cell) wherever each placement is logically sound; the definition audit governs each placement on its own. Do not remove a name from a cell because it also lives elsewhere.
