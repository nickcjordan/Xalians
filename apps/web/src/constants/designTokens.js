...
export const terminals = {
	...
	registry: {
		...
		faceLo: '#070505',
		faceHi: '#1c1515',
		// The counter's own dark-lacquer body (faceLo/faceHi) needs light
		// ink; the docket's paper ink is a separate token (--g-paper-ink)
		// since paper is its own medium (Rule A / round3-coherence.md).
		faceInk: '#e9dfc8',
		faceInkMid: '#a89d86',
		faceInkLow: '#6e6558',
		trim: '#c9a44a',
	...
	archive: {
		...
		faceLo: '#2e3b3e',
		faceHi: '#465659',
		// The desk's own dark sea-slate body (faceLo/faceHi) needs light
		// ink; the card's ink is the separate --g-paper-ink token.
		faceInk: '#e6dfcc',
		faceInkMid: '#a9b3b0',
		faceInkLow: '#7d8886',
		trim: '#7d9397',
