...
function LongReturnGame() {
  ...
  const displayedAction = useMemo(() => actionTransition && ({ ...actionTransition, crew, runFlags }), [actionTransition, crew, runFlags]);
