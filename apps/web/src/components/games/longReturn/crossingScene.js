...
const PASSAGES = {
  ...
  stabilize: ['Thin plates tremble inside a wavering field of light. Each time it flickers, they slip a little farther out of place. The crew must steady the failing machinery long enough to lift the record clear.', 'The last plate comes free. Gathered together, the plates hold the Nemesis Index—the surviving record of the plague research done here. It is no longer something the crew must reach. It is something they must bring home.'],
  blackbox: ['A sealed box sits at the heart of the flickering archive: the backup holding its essential record. Metal catches clamp it to the cradle. Pulling it loose will save the record, but leave the failing chamber without its support.', 'The final catch releases. The crew draws the sealed backup away as the cradle gives behind it. The Nemesis Index is in their keeping now; bringing it home matters more than anything still left in this place.'],
  harvest: ['Light moves beneath the reservoir surface. Around its rim, collector valves offer a way to recover the stored charge a little at a time.', 'The recovered charge is secured for carrying. Beyond the reservoir lies the Generator Spine, deeper inside the annex. The crew gathers at the junction with the extraction route.'],
  dive: ['Beneath the charged liquid, an intact storage cell remains caught in its housing. Reaching it means working past the reservoir surface, not merely collecting from the rim.', 'The cell clears its housing and reaches the rim. The crew secures the recovered charge before turning toward the way out of the reservoir.'],
