...
const PASSAGES = {
  ...
  blackbox: ['At the center of the failing archive, the blackbox still holds the essential record. Its catches bind it to a cradle that will not survive being left without it.', 'The blackbox comes clear. The crew carries the Nemesis Index away from the failing cradle; the essential record no longer depends on this chamber surviving.'],
