...
import {
  ...
  CornerDownRight, Cpu, Crosshair, DoorOpen, Droplet, Eye, EyeOff, Gauge, Hammer, Heart,
  Hourglass, Info, KeyRound, Layers, Lock, MapPin, MessageCircle,
  MessageCircleQuestion, MessageSquareQuote, MoonStar, Network, OctagonAlert, Package,
...
const ICONS = {
  ...
  'bi-bookmark-check': BookmarkCheck, 'bi-box-arrow-down': Box, 'bi-box-seam': Package,
  'bi-brightness-high': Sun, 'bi-broadcast': Radio, 'bi-broadcast-pin': RadioTower, 'bi-building': Building2,
  'bi-bullseye': Target, 'bi-chat-dots': MessageCircle,
  'bi-chat-quote': MessageSquareQuote, 'bi-check-circle': CircleCheck,
  ...
  'bi-diagram-3-fill': Network, 'bi-door-open': DoorOpen, 'bi-droplet-fill': Droplet,
  ...
  'bi-eye-slash': EyeOff, 'bi-geo-alt-fill': MapPin, 'bi-hammer': Hammer,
  'bi-heart-fill': Heart, 'bi-hourglass-split': Hourglass,
  ...
  'bi-play-fill': Play, 'bi-plus-lg': Plus,
  ...
  'bi-shield-exclamation': ShieldAlert, 'bi-shield-fill-check': ShieldCheck,
  ...
  'bi-volume-up-fill': Volume2, 'bi-water': Waves, 'bi-wind': Wind, 'bi-x-lg': X,
};
