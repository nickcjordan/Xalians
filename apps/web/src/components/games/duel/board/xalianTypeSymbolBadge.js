...
class XalianTypeSymbolBadge extends React.Component {
	...
	render() {
		...
		return (
			<div className={`vertically-center-contents ${classes}`} style={{ height: newSize, width: newSize, pointerEvents: 'none', background: `radial-gradient(circle, ${primaryColor} 60%, ${primaryColor + '85'} 100%)`, filter: 'drop-shadow(0px 0px 3px #000000)' }}>
