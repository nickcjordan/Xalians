...
export const LEGEND_ITEMS = [
	...
	{ key: 'why', selector: '[data-slot-state="hand"] .rec-fit .rec-why', text: 'The dashed box is what it holds at a world that neither helps nor hurts it. Under each column, what changed it and by how much: a house ×1½ on its home world; a flame or a snowflake ×½ where the world is too hot or too cold (×¼ when far off); the world’s air or water struck out ×½ or ×¼ where it cannot breathe. No mark: the world leaves it as it is. Point at a creature or lift it, and each world says in words what changes it there, and why.' },
