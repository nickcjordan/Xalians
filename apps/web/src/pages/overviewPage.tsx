// Tier: chrome. The overview: the splash, the fourteen worlds and a species
// strip as featured components, and the site's destinations. This was the
// home page until the story front door (docs/design/home-story-page-brief.md)
// replaced it; it is kept, unlinked, at /overview as a reusable page.
