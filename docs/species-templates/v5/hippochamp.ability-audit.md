...
Review date: 2026-09-21. Status: staged, not released. Sources: `../hippochamp.json`, `../hippochamp.md`, `../art/hippochamp.png`, canonical teaser and Poseidas record. The teaser remains verbatim.
