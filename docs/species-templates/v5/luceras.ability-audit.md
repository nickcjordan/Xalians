...
Review date: 2026-09-21. Status: staged, not released. Sources: `../luceras.json`, `../luceras.md`, `../art/luceras.png`, the canonical species description, and Saiphus's planetary record. `lore.description` remains verbatim.
