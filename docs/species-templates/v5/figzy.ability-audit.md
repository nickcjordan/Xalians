...
Review date: 2026-09-21. Status: staged, not released. Sources: `../figzy.json`, `../figzy.md`, `../art/figzy.png`, canonical teaser and Telypso record. The teaser remains verbatim.
