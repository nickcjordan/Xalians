...
- **feeding**: It feeds on the light of the twin suns through the gems on its head.
...
Fields required (Nick, 2026-09-10): filled feeding ("It feeds on the light of the twin suns through the gems on its head."); company ("It lives alone."). Source reading: the teaser, the diet key and the planet history; where they are silent the phrase is the plainest reading of the record and is flagged for Nick with the batch.
