...
- **company**: Wildcatters kept several at a time. Left to itself it hunts alone.
...
Fields required (Nick, 2026-09-10): filled company ("Wildcatters kept several at a time. Left to itself it hunts alone."). Source reading: the teaser, the diet key and the planet history; where they are silent the phrase is the plainest reading of the record and is flagged for Nick with the batch.
