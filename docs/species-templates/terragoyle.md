...
- **feeding**: It eats when it wakes, whatever the rim offers, and goes long stretches without.
...
Fields required (Nick, 2026-09-10): filled feeding ("It eats when it wakes, whatever the rim offers, and goes long stretches without."). Source reading: the teaser, the diet key and the planet history; where they are silent the phrase is the plainest reading of the record and is flagged for Nick with the batch.
