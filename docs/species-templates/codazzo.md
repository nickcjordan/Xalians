...
- **feeding**: It feeds on what it digs up and on what comes too near its burrow.
...
- **company**: It lives alone in its burrow.
...
Fields required (Nick, 2026-09-10): filled feeding ("It feeds on what it digs up and on what comes too near its burrow."); company ("It lives alone in its burrow."). Source reading: the teaser, the diet key and the planet history; where they are silent the phrase is the plainest reading of the record and is flagged for Nick with the batch.
