...
const TRAITS = ['healing', 'protective', 'regenerative', 'armored', 'anchored', 'phasing', 'resistant', 'hardened', 'dormant', 'insulated', 'territorial', 'grappling', 'commanding', 'ramming', 'toxic', 'volatile', 'reflective', 'menacing', 'hypnotic', 'perceptive', 'foresighted', 'mind-sealed', 'pack-bonded', 'solitary', 'stealthy', 'nocturnal', 'inspiring', 'slippery', 'luminous', 'telekinetic'];
