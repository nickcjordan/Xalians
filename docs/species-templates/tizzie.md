...
- **company**: It lives among others of its kind in the branches.
...
Batch three sign-off (Nick, 2026-09-10): company amended on the orchestrator's recommendation, overridable: was 'It lives among others of its kind in the branches, and since the Plague they turn on each other.'.

Fields required (Nick, 2026-09-10): filled company ("It lives among others of its kind in the branches."). Source reading: the teaser, the diet key and the planet history; where they are silent the phrase is the plainest reading of the record and is flagged for Nick with the batch.
