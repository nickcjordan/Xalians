...
Seven supporting illustrations give otherwise unillustrated technology and discoveries a visual presence. Generated with the built-in image tool; exact prompts, sources and output paths are in `lore-art-prompts.json`.
...
## Final resource pass and stopping rule

- Algael: blue-green medicinal gel, shown in its entry and Poseidas history paragraph 6 in The Story.
- Nightcap: thick oil for stasis travel, shared by Nightcap and Spacer's Tea entries and Endessa history paragraph 3 in The Story.
- QED: a paired set of engineered chips, shown in its entry and the APEX Accords beat. The image depicts finished devices, not a technical explanation of entanglement.

Container shapes, machinery and staging are interpretations. No patients, creatures, living microbial specimens or new facts about manufacture are depicted. Captions follow the existing definitions and history.

Stop this supporting-art collection at seven illustrations. Maintain dedicated art for every planet and creature and existing era openings. Additional index entries remain text-first; add another illustration only when it explains a central story concept existing art cannot convey, reusing images for aliases and related entries.
