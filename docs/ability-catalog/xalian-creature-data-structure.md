...
Purpose: a self-contained description of the ratified Xalians creature data system, written so a fresh conversation can brainstorm new games on top of it without any prior session context. Everything here is ratified design as of 2026-09-01 unless marked in-progress. The authoritative long-form design doc is `C:\Users\njord\.claude\plans\xalian-creature-system-redesign.md`; this file is the condensed consumer-facing view.
...
- Master design doc (all rulings, trait tables, tilt tiers, pipeline): `C:\Users\njord\.claude\plans\xalian-creature-system-redesign.md`
- Anatomy system + allowed-actions matrix: `C:\Users\njord\.claude\plans\xalian-catalog\anatomy-consolidated.md`
- Name catalogs + harvests + composition briefs: `C:\Users\njord\.claude\plans\xalian-catalog\` (working copies) and the repo branch `data/ability-catalog` under `docs/ability-catalog/` (persisted, pushed to GitHub)
