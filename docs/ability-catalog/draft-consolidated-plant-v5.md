# PLANT — Consolidated Ability-Name Catalog (draft v5)
...
## STRIKE (174 names — matrix-reconciled; supersedes composer's own narrative "79")

Root Blow, Root Strike, Root Impact, Root Smash, Root Slam, Root Crack, Root Bash, Root Wallop, Root Knock, Root Crash, Root Ram, Root Butt, Root Headbutt, Root Charge, Root Barge, Root Gore, Root Sledge Blow, Root Pile Driver, Root Jolt, Root Jar, Root Wrench, Root Crunch, Root Snap, Root Backhand, Root Forehand, Root Downstrike, Thorn Strike, Thorn Crack, Thorn Jab, Thorn Gore, Thorn Headbutt, Thorn Jolt, Thorn Jar, Thorn Snap, Thorn Backhand, Thorn Forehand, Thorn Downstrike, Bramble Strike, Bramble Smash, Bramble Slam, Bramble Crack, Bramble Bash, Bramble Wallop, Bramble Clobber, Bramble Crash, Bramble Collision, Bramble Ram, Bramble Charge, Bramble Barge, Bramble Trample, Bramble Hammer Blow, Bramble Sledge Blow, Bramble Crunch, Bramble Backhand, Bramble Forehand, Branch Blow, Branch Strike, Branch Impact, Branch Whack, Branch Thump, Branch Thud, Branch Bash, Branch Wallop, Branch Clobber, Branch Belt, Branch Jab, Branch Slap, Branch Chop, Branch Knock, Branch Rap, Branch Crash, Branch Collision, Branch Buffet, Branch Stroke, Branch Swat, Branch Ram, Branch Charge, Branch Barge, Branch Hammer Blow, Branch Sledge Blow, Branch Jolt, Branch Jar, Branch Wrench, Branch Crunch, Branch Snap, Branch Backhand, Branch Forehand, Branch Downstrike, Taproot Strike, Taproot Jab, Taproot Gore, Taproot Downstrike, Taproot Pile Driver, Taproot Jolt, Taproot Jar, Bramblewood Blow, Bramblewood Impact, Bramblewood Smash, Bramblewood Slam, Bramblewood Crash, Bramblewood Bash, Bramblewood Wallop, Bramblewood Clobber, Bramblewood Ram, Bramblewood Charge, Bramblewood Barge, Bramblewood Hammer Blow, Bramblewood Sledge Blow, Bramblewood Crunch, Bramblewood Collision, Burr Crack, Burr Snap, Burr Jab, Burr Strike, Seedpod Crack, Seedpod Snap, Seedpod Crunch, Seedpod Strike, Seedpod Jab, Spine Strike, Spine Crack, Spine Jab, Spine Gore, Spine Headbutt, Spine Jolt, Spine Jar, Spine Snap, Spine Backhand, Spine Forehand, Spine Downstrike, Barb Strike, Barb Crack, Barb Jab, Barb Gore, Barb Headbutt, Barb Jolt, Barb Jar, Barb Snap, Barb Backhand, Barb Forehand, Barb Downstrike, Bough Blow, Bough Strike, Bough Impact, Bough Whack, Bough Thump, Bough Thud, Bough Bash, Bough Wallop, Bough Clobber, Bough Belt, Bough Jab, Bough Slap, Bough Chop, Bough Knock, Bough Rap, Bough Crash, Bough Collision, Bough Buffet, Bough Stroke, Bough Swat, Bough Ram, Bough Charge, Bough Barge, Bough Hammer Blow, Bough Sledge Blow, Bough Jolt, Bough Jar, Bough Wrench, Bough Crunch, Bough Snap, Bough Backhand, Bough Forehand, Bough Downstrike.

*Fold-in note: the composer's own STRIKE section header and closing "STRIKE count: 79 kept" line undercounted; the per-row matrix K-lists (the authoritative per-intersection record per brief §9.5) sum to 174 unique names — Root 26, Thorn 11, Bramble 18, Branch 33, Taproot 7, Bramblewood 15, Burr 4, Seedpod 5, Spine 11 (parallel to Thorn), Barb 11 (parallel to Thorn), Bough 33 (parallel to Branch). Verified by script against the source matrix; zero duplicates. Adopted 174 as authoritative per the mandate's trust-itemized-lists-over-count-labels rule.*

*Instrument tags: [roots] on Root-fronted names; [spines] on Thorn/Barb/Spine-fronted names; [spines/tendrils] on Bramble-fronted names. Root Gore/Thorn Gore/Barb Gore/Spine Gore and Bramblewood Hammer Blow/Bramble Sledge Blow/Root Sledge Blow/Root Pile Driver are anatomy/tool-vocabulary dual-register flags, kept per rule 6.9. Burr Strike/Seedpod Strike are dual candidates with HURL, kept here for the discrete-impact sense.*

*Signature-register release: **Thornburst** (grander single-burst image, also cross-tension with BURST — released to signature pool, not placed in any cell).*
...
*Flags: **Thorn Lash** and **Bramble Whip** sit close in cadence to the excluded Vine Whip/Thorn Whip franchise pattern but are not the exact strings — kept per "when in doubt, keep and flag," B-adjacent risk noted for final audit. **Vine Whip** and **Thorn Whip** themselves are RATIFIED CUTS (Pokemon moves) — never composed, never restored.*

*Cross-cell resolution: **Thorn Slash** was explicitly split by the composer — dispositioned D under LASH (a single point cannot sweep/arc) but K under RAKE (a single point can scratch/cut repeatedly, the "one of many quick strokes" sense differs definitionally from LASH's single-sweep sense). Thorn Slash lives in RAKE (see below); it is not a LASH name. Bramble Slash and Bramble Crack are LASH-owned (kept here); RAKE's own composer correctly excluded these as X, reserved to LASH.*
...
*Instrument tags: [spines] on Thorn/Spine-fronted names; [roots] on Root-fronted names; [tendrils] on Vine/Tendril-fronted names.*
...
*Instrument tags: [roots] on Root-fronted names; [spines] on Burr/Thorn-fronted names; [tendrils] on Vine-fronted names.*

*Flags: **Root Catapult** anatomy-honest mechanism (a root uncoiling like a catapult arm). Vine's HURL contribution is narrow by design (Vine Catapult, Vine Sling) since a vine is honestly a launching mechanism, not itself a dischargeable mass.*

*Register tension kept (not rejected): **Sapling Toss** checked for comic-collocation risk (hurling a small tree), judged a plausible non-comic mass-projectile image.*

*Borrowed exclusions confirmed absent: Vine Whip, Thorn Whip, Leaf Blade, Petal Dance, Razor Leaf, Solar Beam, Wood Hammer (all pre-excluded at harvest stage).*
...
*Chemical-boundary note: none of BURST's names lean chemical; the boundary flags in this element concentrate in CLOUD (see below).*
...
*Chemical-boundary flags (kept, not cut, per plant canon — spores are plant-owned): Bloom Miasma, Spore Miasma, Spore Pall, Spore Murk, and by extension the restored Pollen Miasma, Bloom Pall/Haze/Murk, Moss Miasma carry the same noxious-adjacent register lean; flagged for auditor awareness of the chemical-boundary proximity, not excluded.*
...
*Instrument tags: [tendrils/coils] on Chokehold; [tendrils] on Vine/Tendril-fronted names; [roots] on Root-fronted names; [thorns] on Bramble Crush.*

*Scope note: per the assignment's own canon carve-out, grip/clutch/clasp/hold-type words route to SNARE, not CRUSH — CRUSH keeps only the squeeze/constrict/press-shut register, which narrows this cell relative to WARD/MEND but is the correct, non-padded result.*

*Gap flag: **Vine Vise** was never composed here (only Root Vise was tested and rejected D) despite SNARE's composer flagging it as CRUSH's to claim — see SNARE's cross-cell resolution note above.*
...
*Instrument tags: [thorns] on Bramble/Thorn-fronted names; [roots] on Root/Taproot-fronted names; [hide]/[shell] on Bark-fronted names per whether the reading is skin-like hide or rigid-plate shell; [tendrils] on Vine/Tendril-fronted names; [spines] on Thorn Armor/Guard, Spine Guard.*

*Kept-under-doubt flags: **Root/Vine/Bramble/Thicket Guardian** (personification of growth as protector-figure); **Bark Carapace/Casing/Plating** (borrowed-material connotation but honestly bark-rigid per real-world bark armor); **Bramble Sanctuary/Haven/Refuge** (thorned-hostile vs. welcoming-word tension, kept since the barrier-protects-interior sense is honest regardless of the barrier's own texture).*

*Near-miss on signature register: the Bastion cluster (Root/Thicket/Bramble Bastion) was checked and judged plain-tier, kept — not released. Fortress/Citadel/Keep/Turret/Parapet/Stockade/Palisade (except Thorn Palisade) were rejected as architecturally over-grand/mismatched for an organic fronting noun (definition mismatch, not signature-release).*
...
*Instrument tags: [roots] on Root-fronted names; [tendrils] on Vine/Tendril Knit.*

*Religious/ritual register is IN per Nick's standing pilot ruling (Blessing/Benediction/Grace throughout).*

*Canon check: **Seed Awakening** explicitly checked against the never-create-new-life rule (rule 6.11) — compliant, this is self-regrowth of the caster's own biology, not animating an independent creature.*
...
*Instrument tags: [spines] on Thorn Bristle/Thorn Display.*

*Cross-cell/dual note: **Creeping Dread** shares its "creeping" word with dark's own abstract-doom register — kept in plant per plant's own independently honest use (vine/growth movement is plant-native), not a borrowing.*

*Flags: **Overgrowth/Thicket/Bramble Haunt** kept under the harvest's secondary "prey on the mind persistently" sense (non-spectral), flagged as the reading most likely to seem ghost-leaning to a player — auditor judgment call. **Thorn Menace/Threat** kept while Thorn Dread/Terror/Horror/Fear/Gloom/Doom were cut as too thin a fronting noun for the abstract-mood cluster — a fine distinction (concrete-threat vs. abstract-mood) flagged for consistency review. **Wild Menace** kept alongside near-duplicate Untamed Menace per the near-duplicates-welcome rule.*

---

## Signature-Register Pool (released, never dropped)

Names judged grander than the plain 2-word catalog tier are released here rather than kept in a combat cell or discarded:

- **Thornburst** (STRIKE) — grander single-burst impact image; also cross-tension with BURST.
- **Thorn Laceration, Bramble Laceration** (RAKE) — clinical/medical register, above plain-tier.
- **Root Overthrow** (SHOVE) — grander political/regime-change connotation.
- **Root Cataclysm, Bramble Cataclysm, Seed Cataclysm** (BURST) — flagged per the harvest's own explicit "use sparingly, very strong" register note on Cataclysm.

No signature-register names arose in DRAIN, AMBUSH, BEAM, HURL, SPRAY, CLOUD, SNARE, CRUSH, WARD, MEND, or TERRORIZE (each composer explicitly checked and reported none, or in WARD's case checked the Bastion cluster and judged it plain-tier rather than releasing it).

---

## Flags (merged from all four composers)

**Borrowed-name exclusions (ratified cuts, never composed or restored):**
Vine Whip, Thorn Whip (exact Pokemon-move matches — STRIKE/LASH). Leech Seed, Bullet Seed, Seed Bomb, Giga Drain (DRAIN). Leaf Blade, Petal Dance, Razor Leaf, Solar Beam, Wood Hammer (HURL/BEAM). Sleep Powder, Stun Spore, Cotton Spore — checked, no collision found among CLOUD's spore-based names, but flagged for auditor re-check given thematic proximity to CLOUD's status-effect-adjacent flavor. Root Vise — rejected as a wholesale non-plant mechanical-tool noun (CRUSH).

**Earth-flora/wetland boundary flag (Reed):** carried through every batch. Reed produces two kept names in LASH (Reed Scythe, Reed Reap, both flagged), and is confirmed absent (tested, no honest pairing) from every other cell in the catalog (STRIKE, RAKE, SHOVE, DRAIN, AMBUSH, BEAM, HURL, SPRAY, BURST, CLOUD, SNARE, CRUSH, WARD, MEND, TERRORIZE).

**Chemical-boundary flags (kept, not cut — spores/sap are plant-owned per canon; toxin/venom proper stays chemical's):** Bloom Miasma, Spore Miasma, Spore Pall, Spore Murk, and the restored Pollen Miasma / Bloom Pall / Bloom Haze / Bloom Murk / Moss Miasma (CLOUD). Bramble Paralyze was cut (not restored — not in the extraction file) for reaching fully into chemical's neurological/toxin register rather than merely bordering it.

**Cross-cell definition tensions (kept in both, or resolved to one, per definitional-honesty per name):**
- **Thorn Slash** — split by definition: LASH excludes it (a point can't sweep), RAKE keeps it (a point can scratch repeatedly). Lives in RAKE only. See RAKE's cross-cell resolution note.
- **Root Strike / Bramble Strike** — resolved to STRIKE ownership; excluded from AMBUSH per the impact→strike rule.
- **Root Coil** — kept independently in both DRAIN (drain-while-coiled) and CRUSH (squeeze-to-crush); genuinely distinct action-definitional senses of the same fronting compound, not a rule-7 violation.
- **Spore Mist / Pollen Plume / Spore Plume** — live in SPRAY only; CLOUD-cell attempts correctly excluded (X, already kept elsewhere).
- **Creeping Dread** — shared word with dark's abstract-doom register; kept in plant (TERRORIZE) as independently honest.
- **Thorn Hamstring** — kept in SNARE (plant has honest piercing anatomy, unlike water which lacks it); a hypothetical RAKE-cell placement was flagged as a live tension by file C but RAKE (file A) never composed it, so it remains SNARE-only.
- **Vine Vise** — fell through a genuine gap between SNARE (file C, which held it out for CRUSH) and CRUSH (file D, which never independently composed it). Not present in this catalog under either cell; flagged for a future targeted pass, not fabricated as a keep.

**Register-tension names kept (not comic, just unusual):** Thorn Milking, Sap Milking (DRAIN); Sapling Toss (HURL); Sap Cascade, Resin Cascade (SPRAY, viscous-fluid reading distinct from water's liquid-stream reading).

**Anatomy-instrument tag registry used across this element:** [roots], [tendrils], [spines], [thorns], [hide], [shell], [vents], [secretion], [breath], [coils]. Tag choice follows each composer's own structural judgment (e.g. Bramble's thorny mass is tagged [thorns] in some cells and [spines/tendrils] in others depending on whether the point or the tangle is doing the work in that specific name) — preserved as-composed rather than force-normalized, since both are valid registry entries describing different honest readings of the same plant.
...
## Restoration Ledger (every line of redundancy-rejections-plant.txt dispositioned)
