...
3. Resolve ongoing-passive target acquisition: self/self-centered areas are the proposed boundary, pending the user's answer. The 32-species prose/data screening did not establish a need for a conditional-physiology subsystem; revisit only for an evidenced case during full species authoring.
