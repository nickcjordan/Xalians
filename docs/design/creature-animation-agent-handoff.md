...
Updated 2026-09-20 after the second art pass and the move to a spec-driven rig library. This is a self-contained continuation brief for the current Xalians creature-art and animation exploration. It records the user's intent, current evidence, implementation locations, constraints, and the next useful work. It does not select a permanent visual style or authorize integration into a game.
