...
```jsonc
{
  ...
  "traits": {
    "guaranteed": ["armored", "anchored"],          // granted by the body — every member has them
    "rolled": ["stealthy"]                          // this individual's pulls
  },
...
```jsonc
{
  ...
  "traits": { "count": [1,2], "pool": { "charger": 5, "pack-hunter": 3, "emberhide": 1 } },
