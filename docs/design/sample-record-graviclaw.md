...
Generator version 0.2.0, schema version 1.0.0. Records only reproduce within a generator version, so regenerate this file whenever `GENERATOR_VERSION` moves.
