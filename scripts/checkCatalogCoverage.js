...
function renderReport(coverage) {
	...
	lines.push('');
	lines.push(`Generated by \`scripts/checkCatalogCoverage.js\` from \`packages/content/json/speciesRecords.json\`, \`registries.json\`, and \`abilityCatalog.json\`, on ${coverage.generatedAt}.`);
	lines.push('');
